...
def open_url_flipkart(event):
        global flipkart
        webbrowser.open_new(flipkart)
        
def open_url_amazon(event):
        global amazon
        webbrowser.open_new(amazon)
        
def open_url_ebay(event):
        global ebay
        webbrowser.open_new(ebay)
        
def open_url_croma(event):
        global croma
        webbrowser.open_new(croma)
        
def open_url_olx(event):
        global olx
        webbrowser.open_new(olx)
...
def search():
    ...
    box7.insert(1.0,"Loding...")
    '''box8.insert(1.0,"Loding...")
    box9.insert(1.0,"Loding...")
    box10.insert(1.0,"Loding...")'''
...
box6 =  Text(window, height=10, width=20, yscrollcommand=scrollbar.set, fg="blue", cursor="hand2")
box6.place(relx=0.8, rely=0.8, anchor="center")
box6.bind("<Button-1>", open_url_flipkart)

box7 =  Text(window, height=10, width=20, yscrollcommand=scrollbar.set, fg="blue", cursor="hand2")
box7.place(relx=0.8, rely=0.9, anchor="center")
box7.bind("<Button-1>", open_url_amazon)
